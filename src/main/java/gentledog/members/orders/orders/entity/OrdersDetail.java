...
@Table(name = "orders_detail", catalog = "orders")
public class OrdersDetail extends BaseTimeEntity {
    ...
    private VendorsOrdersList vendorsOrdersList;
    ...
    public void updateProductOrdersStatus(OrdersDetailStatus productOrdersStatus) {
        this.productOrdersStatus = productOrdersStatus;
    }

    // 상품 VendorsOrderList 변경
    public void updateVendorsOrderList(VendorsOrdersList vendorsOrdersList) {
        this.vendorsOrdersList = vendorsOrdersList;
    }
